...
@DynamicUpdate
@DynamicInsert
@Table(name = "userworkingdays")
public class UserWorkingDays implements Serializable {

    private static final long serialVersionUID = 1L;

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "USERWORKINGDAYS_SEQ")
